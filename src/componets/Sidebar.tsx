            ...
            <section className="flex flex-col justify-center gap-6">
                ...
                <div className="flex flex-col items-center md:items-start px-4 justify-center gap-8 dark:text-zinc-300">
                    <a href="/" className="flex flex-col md:flex-row items-center justify-center gap-1">
                        ...
                        <p className="md:text-[16px] text-[12px]  hover:animate-scale ">Home</p>
                    </a>
                    <a href="/figma" className="flex flex-col  md:flex-row items-center justify-center gap-1">
                        <div className={`dark:hover:bg-[#f7f3f236] hover:bg-[#1c1d1c45] p-1 rounded-lg ${isFigma ? 'dark:bg-[#f7f3f236]' : ''} ${isFigma ? 'bg-[#1c1c1d45]' : ''} transition-all duration-300 hover:animate-swing`}>
                        ...
                        <p className="md:text-[16px] text-[12px]  hover:animate-scale">Figma to UI</p>
                    </a>
                    <a href="/image" className="flex flex-col  md:flex-row items-center justify-center gap-1">
                        <div className={`dark:hover:bg-[#f7f3f236] hover:bg-[#1c1d1c45] p-1 rounded-lg ${isImage ? 'dark:bg-[#f7f3f236]' : ''} ${isImage ? 'bg-[#1c1c1d45]' : ''} transition-all duration-300 hover:animate-swing`}>
                        ...
                        <p className="md:text-[16px] text-[12px]  hover:animate-scale">Image to UI</p>
                    </a>
                    <a href="/diagram" className="flex flex-col  md:flex-row items-center justify-center gap-1">
                        <div className={`dark:hover:bg-[#f7f3f236] hover:bg-[#1c1d1c45] p-1 rounded-lg ${isDiagram ? 'dark:bg-[#f7f3f236]' : ''} ${isDiagram ? 'bg-[#1c1c1d45]' : ''} transition-all duration-300 hover:animate-swing`}>
                            <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1} strokeLinecap="round" strokeLinejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-library-photo"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M7 3m0 2.667a2.667 2.667 0 0 1 2.667 -2.667h8.666a2.667 2.667 0 0 1 2.667 2.667v8.666a2.667 2.667 0 0 1 -2.667 2.667h-8.666a2.667 2.667 0 0 1 -2.667 -2.667z" /><path d="M4.012 7.26a2.005 2.005 0 0 0 -1.012 1.737v10c0 1.1 .9 2 2 2h10c.75 0 1.158 -.385 1.5 -1" /><path d="M17 7h.01" /><path d="M7 13l3.644 -3.644a1.21 1.21 0 0 1 1.712 0l3.644 3.644" /><path d="M15 12l1.644 -1.644a1.21 1.21 0 0 1 1.712 0l2.644 2.644" /></svg>
                        </div>
                        <p className="md:text-[16px] text-[12px]  hover:animate-scale">Diagram to UI</p>
                    </a>
                </div>
            </section>
            {
                user && (
                    ...
                    >
                        ...
                        />
                        <p className="text-zinc-500 font-semibold max-md:hidden">
                            {user.given_name}
                        </p>
                    </a>
                )
